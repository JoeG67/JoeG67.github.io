...
$sql = "SELECT * FROM room_rental where status = 'Pending Approval'";
$result = $db->query($sql);
$role_action = "";
...
<head>
  ...
  <title>Room Rental Approval List - Library Management System</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Room Rental Approval List</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="userPage.php">Home</a></li>
          <li class="breadcrumb-item">Rooms</li>
          <li class="breadcrumb-item active">Room Rental Approval List</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <a href="roomRentalApproval.php?roomRentalId=<?php echo $roomRentalId ?>"><i class="bi bi-eye-fill"></i></a>
                          </td>
