...
if (isset($_POST['pcName']) ) {
    echo '<script>alert("Inside PC ")</script>';
    $pcName = $_POST['pcName'];
    $rentalStatus = $_POST['rentalStatus'];
    
  $sql = "INSERT INTO pc (pc_name, status) 
						  VALUES ('$pcName','$rentalStatus ')";
...
<head>
  ...
  <title>Add PC - Library Management System</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add PC</li>
        </ol>
      </nav>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <?php } ?>
          <form class="row g-3 needs-validation" novalidate id="addPC" name="addPC" method="post" action="addPC.php" enctype="multipart/form-data">

            <div class="card">
              <div class="card-body">
                <h5 class="card-title">PC Details</h5>

                <!-- Vertical Form -->
               
                <div class="row mb-3">
                  <label for="pcName" class="col-sm-2 col-form-label">PC Name</label>
                  <div class="col-sm-2">
