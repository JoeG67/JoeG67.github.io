...
$sql = "SELECT *  FROM pc_rental WHERE pc_rental_id='" . $pcRentalId . "'";
$result = $db->query($sql);
$role_action = "";
...
<head>
  ...
  <title>PC Rental Approval - Library Management System</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>PC Rental Approval </h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin.php">Home</a></li>
          <li class="breadcrumb-item">Request</li>
          <li class="breadcrumb-item active">PC Rental Approval</li>
        </ol>
      </nav>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
          <h5 class="card-title">PC Rental Approval</h5>
          <form class="row g-3 needs-validation" novalidate id="pcRentalApproval" name="pcRentalApproval" method="post" action="" enctype="multipart/form-data">
          <div class="row mb-3">
            ...
            <button type="button" class="btn btn-success" onclick="window.location='approvePCRental.php?pcRentalId=<?php echo $pcRentalId ?>&status=Approved'">Approve</button>
              <button type="button" class="btn btn-danger" onclick="window.location='approvePCRental.php?pcRentalId=<?php echo $pcRentalId ?>&status=Rejected'">Reject</button>
            </div>
          </form>
