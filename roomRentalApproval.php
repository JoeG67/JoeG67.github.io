...
<head>
  ...
  <title>Room Rental Approval - Library Management System</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Room Rental Approval </h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin.php">Home</a></li>
          <li class="breadcrumb-item">Request</li>
          <li class="breadcrumb-item active">Room Rental Approval</li>
        </ol>
      </nav>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
          <h5 class="card-title">Room Rental Approval</h5>
          ...
          <div class="row mb-3">
            ...
            <button type="button" class="btn btn-success" onclick="window.location='approveRoomRental.php?roomRentalId=<?php echo $roomRentalId ?>&status=Approved'">Approve</button>
              <button type="button" class="btn btn-danger" onclick="window.location='approveRoomRental.php?roomRentalId=<?php echo $roomRentalId ?>&status=Rejected'">Reject</button>
            </div>
          </form>
