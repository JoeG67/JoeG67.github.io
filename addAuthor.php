...
if (isset($_POST['authorName']) ) {
    echo '<script>alert("Inside Author ")</script>';
    $authorName = $_POST['authorName'];
    
  $sql = "INSERT INTO author (author_name) 
						  VALUES ('$authorName')";
  if (mysqli_query($db, $sql)) {
	$errorMsg = "Succesfully added author";
	header("Location: authorList.php");
  } else {
	$errorMsg = "Unable to Add author";
  }
}
mysqli_close($db);
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <?php } ?>
          <form class="row g-3 needs-validation" novalidate id="addAuthor" name="addAuthor" method="post" action="addAuthor.php" enctype="multipart/form-data">
