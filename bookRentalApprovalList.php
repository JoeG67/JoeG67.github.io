...
$sql = "SELECT * FROM book_rental where status = 'Pending Approval'";
$result = $db->query($sql);
$role_action = "";
...
<head>
  ...
  <title>Book Rental Approval List - Library Management System</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Book Rental Approval List</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="userPage.php">Home</a></li>
          <li class="breadcrumb-item">Books</li>
          <li class="breadcrumb-item active">Book Rental Approval List</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <a href="bookRentalApproval.php?bookRentalId=<?php echo $bookRentalId ?>"><i class="bi bi-eye-fill"></i></a>
                          </td>
